    ...
    <div class="containerFiltroAv">
        <div class="row align-items-center">
            ...
            <div class="col-auto mb-3 d-flex align-items-center">
                <asp:TextBox runat="server" ID="txtFiltroUsuarios" CssClass="form-control me-2" AutoPostBack="false" OnTextChanged="txtFiltroUsuarios_TextChanged" Enabled="false" oninput="filtrarUsuarios()" />
