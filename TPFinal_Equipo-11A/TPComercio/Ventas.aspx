...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="containerVolver">
        <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text="Volver" OnClick="btnVolver_Click" />
    </div>
                ...
                <asp:Repeater ID="rptVentasClientes" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <!-- Botón Facturar -->
                                <asp:Button Text="Facturar" runat="server" CssClass="btn btn-primary btn-sm" CommandArgument='<%# Eval("Id") %>' ID="btnFactuar" OnCommand="btnFactuar_Command" />
                            </td>
                        </tr>
